            ...
            >
                ...
                <FieldRows
                    items={[
                        ...
                        { icon: "activity", label: "Doctor", value: meta.patient_name ?? undefined, key: "doctor_name" },
                        { icon: "home", label: "Clinic", value: meta.patient_name ?? undefined, key: "clinic_name" },
                        { icon: "calendar", label: "Date", value: meta.patient_name ?? undefined, key: "date" },
                    ]}
                    isEditable={isEditable}
